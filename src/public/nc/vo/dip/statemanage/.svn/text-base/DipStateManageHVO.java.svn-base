 ...
 */
     public class DipStateManageHVO extends SuperVO {
           
             public String pk_statemanage_h;
             ...
             public static final String  PK_STATEMANAGE_H="pk_statemanage_h";   
	 ...
	 */
	 public void validate() throws ValidationException {
	 	...
	 	ArrayList errFields = new ArrayList(); // errFields record those null
	   		...
	   		if (pk_statemanage_h == null) {
			errFields.add(new String("pk_statemanage_h"));
			  }	
	 ...
	 *
	 * 创建日期:2011-4-7
	 * @param newPk_statemanage_h 主键值
	 */
	 public DipStateManageHVO(String newPk_statemanage_h) {
		
		// 为主键字段赋值:
		 pk_statemanage_h = newPk_statemanage_h;
	  ...
	  *
	  * 创建日期:2011-4-7
	  * @param newPk_statemanage_h  String    
	  */
	 public void setPrimaryKey(String newPk_statemanage_h) {
	...
	public String getPk_statemanage_h() {
		return pk_statemanage_h;
	}

	public void setPk_statemanage_h(String pk_statemanage_h) {
		this.pk_statemanage_h = pk_statemanage_h;
	} 
