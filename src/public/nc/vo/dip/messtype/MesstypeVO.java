 ...
 */
     public class MesstypeVO extends SuperVO {
           
             public String code;
             public String princ;
             public String def_str_3;
             public String pk_messtype;
             public String ts;
             ...
             public static final String  PK_MESSTYPE="pk_messtype";   
	...
	public void setCode(String newCode) {
     ...
     /**
	   ...
	   *
	   * 创建日期:2011-4-7
	   * @param newPrinc String
	   */
	public void setPrinc(String newPrinc) {
	...
	public void setDef_str_3(String newDef_str_3) {
        ...
        /**
	   * 属性pk_messtype的Getter方法.
	   *
	   * 创建日期:2011-4-7
	   * @return String
	   */
	 public String getPk_messtype() {
		 return pk_messtype;
	  }   
	  
     /**
	   * 属性pk_messtype的Setter方法.
	   *
	   * 创建日期:2011-4-7
	   * @param newPk_messtype String
	   */
	public void setPk_messtype(String newPk_messtype) {
		
		pk_messtype = newPk_messtype;
	 } 	  
	 ...
	 */
	 public void validate() throws ValidationException {
	 	...
	 	ArrayList errFields = new ArrayList(); // errFields record those null
	   		...
	   		if (pk_messtype == null) {
			errFields.add(new String("pk_messtype"));
			  }	
	 ...
	 *
	 * 创建日期:2011-4-7
	 * @param newPk_messtype 主键值
	 */
	 public MesstypeVO(String newPk_messtype) {
	  ...
	  * @param newPk_messtype  String    
	  */
	 public void setPrimaryKey(String newPk_messtype) {
