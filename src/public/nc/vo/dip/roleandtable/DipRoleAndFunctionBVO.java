...
public class DipRoleAndFunctionBVO extends SuperVO{
	private String   pk_roleandfunction_c;
	private String   pk_roleandtable_h   ;
	private String   module_pk;
	...
	public static final String   PK_ROLEANDFUNCTION_C="pk_roleandfunction_c";
	public static final String   PK_ROLEANDTABLE_H="pk_roleandtable_h"   ;
	public static final String   MODULE_PK="module_pk"   ;
	...
	public String getPk_roleandfunction_c() {
		return pk_roleandfunction_c;
	}
	public void setPk_roleandfunction_c(String pk_roleandfunction_c) {
		this.pk_roleandfunction_c = pk_roleandfunction_c;
	}
	...
	public String getModule_pk() {
		return module_pk;
	}
	public void setModule_pk(String module_pk) {
		this.module_pk = module_pk;
	}
