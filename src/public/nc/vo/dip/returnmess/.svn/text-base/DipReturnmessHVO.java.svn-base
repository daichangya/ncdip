 ...
 */
     public class DipReturnmessHVO extends SuperVO {
	 ...
	 */
	 public void validate() throws ValidationException {
	 	...
	 	ArrayList errFields = new ArrayList(); // errFields record those null
	   		...
	   		if (pk_returnmess_h == null) {
			errFields.add(new String("pk_returnmess_h"));
			  }	
	 ...
	 *
	 * 创建日期:2011-4-1
	 * @param newPk_returnmess_h 主键值
	 */
	 public DipReturnmessHVO(String newPk_returnmess_h) {
	  ...
	  * @param newPk_returnmess_h  String    
	  */
	 public void setPrimaryKey(String newPk_returnmess_h) {
