 ...
 */
     public class DipReturnmessBVO extends SuperVO {
           
             public String code;
             public String pk_returnmess_b;
             public String def_str_3;
             public String ts;
             public String def_str_1;
             public String pk_returnmess_h;
             public Integer dr;
             ...
             public static final String  PK_RETURNMESS_B="pk_returnmess_b";   
             public static final String  DEF_STR_3="def_str_3";   
             public static final String  TS="ts";   
             public static final String  DEF_STR_1="def_str_1";   
             public static final String  PK_RETURNMESS_H="pk_returnmess_h";   
	...
	public void setCode(String newCode) {
        ...
        /**
	   * 属性pk_returnmess_b的Getter方法.
	   *
	   * 创建日期:2011-4-1
	   * @return String
	   */
	 public String getPk_returnmess_b() {
		 return pk_returnmess_b;
	  }   
	  
     /**
	   * 属性pk_returnmess_b的Setter方法.
	   *
	   * 创建日期:2011-4-1
	   * @param newPk_returnmess_b String
	   */
	public void setPk_returnmess_b(String newPk_returnmess_b) {
		
		pk_returnmess_b = newPk_returnmess_b;
	 } 	  
	...
	public void setDef_str_1(String newDef_str_1) {
        ...
        /**
	   * 属性pk_returnmess_h的Getter方法.
	   *
	   * 创建日期:2011-4-1
	   * @return String
	   */
	 public String getPk_returnmess_h() {
		 return pk_returnmess_h;
	  }   
	  
     /**
	   * 属性pk_returnmess_h的Setter方法.
	   *
	   * 创建日期:2011-4-1
	   * @param newPk_returnmess_h String
	   */
	public void setPk_returnmess_h(String newPk_returnmess_h) {
		
		pk_returnmess_h = newPk_returnmess_h;
	 } 	  
	 ...
	 */
	 public void validate() throws ValidationException {
	 	...
	 	ArrayList errFields = new ArrayList(); // errFields record those null
	   		...
	   		if (pk_returnmess_b == null) {
			errFields.add(new String("pk_returnmess_b"));
			  }	
	 ...
	 *
	 * 创建日期:2011-4-1
	 * @param newPk_returnmess_b 主键值
	 */
	 public DipReturnmessBVO(String newPk_returnmess_b) {
	  ...
	  * @param newPk_returnmess_b  String    
	  */
	 public void setPrimaryKey(String newPk_returnmess_b) {
