 ...
 */
     public class DipObtainsignVO extends SuperVO {
           
             public String code;
             public String def_str_3;
             public String ts;
             public String def_str_1;
             public String pk_obtainsign;
             public Integer dr;
             ...
             public static final String  PK_OBTAINSIGN="pk_obtainsign";   
	...
	public void setDef_str_1(String newDef_str_1) {
        ...
        /**
	   * 属性pk_obtainsign的Getter方法.
	   *
	   * 创建日期:2011-4-1
	   * @return String
	   */
	 public String getPk_obtainsign() {
		 return pk_obtainsign;
	  }   
	  
     /**
	   * 属性pk_obtainsign的Setter方法.
	   *
	   * 创建日期:2011-4-1
	   * @param newPk_obtainsign String
	   */
	public void setPk_obtainsign(String newPk_obtainsign) {
		
		pk_obtainsign = newPk_obtainsign;
	 } 	  
	 ...
	 */
	 public void validate() throws ValidationException {
	 	...
	 	ArrayList errFields = new ArrayList(); // errFields record those null
	   		...
	   		if (pk_obtainsign == null) {
			errFields.add(new String("pk_obtainsign"));
			  }	
	 ...
	 *
	 * 创建日期:2011-4-1
	 * @param newPk_obtainsign 主键值
	 */
	 public DipObtainsignVO(String newPk_obtainsign) {
	  ...
	  * @param newPk_obtainsign  String    
	  */
	 public void setPrimaryKey(String newPk_obtainsign) {
