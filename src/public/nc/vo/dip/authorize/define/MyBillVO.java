...
public class  MyBillVO extends HYBillVO /* implements IExAggVO*/ {
	...
	public CircularlyAccessibleValueObject[] getChildrenVO() {
		return (DipADContdataBVO[]) super.getChildrenVO();
	}

	public CircularlyAccessibleValueObject getParentVO() {
		return (DipADContdataVO) super.getParentVO();
	}
	...
	public void setChildrenVO(CircularlyAccessibleValueObject[] children) {
		if (children == null || children.length == 0) {
			...
			super.setChildrenVO((CircularlyAccessibleValueObject[]) Arrays.asList(children).toArray(new DipADContdataBVO[0]));
		}
	}

	public void setParentVO(CircularlyAccessibleValueObject parent) {
		super.setParentVO((DipADContdataVO)parent);
	}
