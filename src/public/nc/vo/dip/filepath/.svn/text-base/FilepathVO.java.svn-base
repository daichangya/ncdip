 ...
 */
     public class FilepathVO extends SuperVO {
           
             public String code;
             public String pk_filepath;
             ...
             public static final String  PK_FILEPATH="pk_filepath";   
	...
	public void setCode(String newCode) {
        ...
        /**
	   * 属性pk_filepath的Getter方法.
	   *
	   * 创建日期:2011-4-7
	   * @return String
	   */
	 public String getPk_filepath() {
		 return pk_filepath;
	  }   
	  
     /**
	   * 属性pk_filepath的Setter方法.
	   *
	   * 创建日期:2011-4-7
	   * @param newPk_filepath String
	   */
	public void setPk_filepath(String newPk_filepath) {
		
		pk_filepath = newPk_filepath;
	 } 	  
	 ...
	 */
	 public void validate() throws ValidationException {
	 	...
	 	ArrayList errFields = new ArrayList(); // errFields record those null
	   		...
	   		if (pk_filepath == null) {
			errFields.add(new String("pk_filepath"));
			  }	
	 ...
	 *
	 * 创建日期:2011-4-7
	 * @param newPk_filepath 主键值
	 */
	 public FilepathVO(String newPk_filepath) {
	  ...
	  * @param newPk_filepath  String    
	  */
	 public void setPrimaryKey(String newPk_filepath) {
