 ...
 */
     public class DipRepeatdataVO extends SuperVO {
           
             public String def_str_3;
             public String property;
             public String messserver;
             public Integer dr;
             public String code;
             ...
             public static final String  PK_REPEATDATA="pk_repeatdata";   
	...
	public void setProperty(String newProperty) {
        ...
        /**
	   * 属性messserver的Getter方法.
	   *
	   * 创建日期:2011-4-1
	   * @return String
	   */
	 public String getMessserver() {
		 return messserver;
	  }   
	  
     /**
	   * 属性messserver的Setter方法.
	   *
	   * 创建日期:2011-4-1
	   * @param newMessserver String
	   */
	public void setMessserver(String newMessserver) {
		
		messserver = newMessserver;
	 } 	  
	...
	public void setTs(String newTs) {
     ...
     /**
	   ...
	   *
	   * 创建日期:2011-4-1
	   * @param newMesstype String
	   */
	public void setMesstype(String newMesstype) {
	...
	public void setName(String newName) {
        ...
        /**
	   * 属性pk_repeatdata的Getter方法.
	   *
	   * 创建日期:2011-4-1
	   * @return String
	   */
	 public String getPk_repeatdata() {
		 return pk_repeatdata;
	  }   
	  
     /**
	   * 属性pk_repeatdata的Setter方法.
	   *
	   * 创建日期:2011-4-1
	   * @param newPk_repeatdata String
	   */
	public void setPk_repeatdata(String newPk_repeatdata) {
		
		pk_repeatdata = newPk_repeatdata;
	 } 	  
	 ...
	 */
	 public void validate() throws ValidationException {
	 	...
	 	ArrayList errFields = new ArrayList(); // errFields record those null
	   		...
	   		if (pk_repeatdata == null) {
			errFields.add(new String("pk_repeatdata"));
			  }	
	 ...
	 *
	 * 创建日期:2011-4-1
	 * @param newPk_repeatdata 主键值
	 */
	 public DipRepeatdataVO(String newPk_repeatdata) {
	  ...
	  * @param newPk_repeatdata  String    
	  */
	 public void setPrimaryKey(String newPk_repeatdata) {
