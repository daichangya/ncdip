 ...
 */
     public class DipConsttabVO extends SuperVO {
           
             public String code;
             public String pk_consttab;
	 ...
	 */
	 public void validate() throws ValidationException {
	 	...
	 	ArrayList errFields = new ArrayList(); // errFields record those null
	   		...
	   		if (pk_consttab == null) {
			errFields.add(new String("pk_consttab"));
			  }	
	 ...
	 */
	 public DipConsttabVO(String newPk_recserver) {
		
		// 为主键字段赋值:
		 pk_consttab = newPk_recserver;
	...
	public String getPk_consttab() {
		return pk_consttab;
	}

	public void setPk_consttab(String pk_consttab) {
		this.pk_consttab = pk_consttab;
	} 
} 
