 ...
 */
     public class VDipAuthDesignVO extends SuperVO {
             ...
             public UFBoolean is_single_list;
             public UFBoolean is_list;
            
       
   	public UFBoolean getIs_single_list() {
				return is_single_list;
			}

			public void setIs_single_list(UFBoolean is_single_list) {
				this.is_single_list = is_single_list;
			}

			public UFBoolean getIs_list() {
				return is_list;
			}

			public void setIs_list(UFBoolean is_list) {
