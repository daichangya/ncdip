...
public class WarningConditionDlg extends UIDialog {
	...
	private JTextField refCondition = null;
...
//	private UIRefPane refBeginDate = null;
	...
	public WarningConditionDlg() {
		super();
		initialize();
	}

	@SuppressWarnings("deprecation")
	public WarningConditionDlg(HashMap bufferCondition) {
		super();
	 ...
	 */
	@SuppressWarnings("deprecation")
	public WarningConditionDlg(HashMap bufferCondition, HashMap clientUIData) {
		super();
		this.setBufferCondition(bufferCondition);
...
//			 jPanel.add(getRefBankAcc(),null);
	 ...
	 * 预警任务条件
	 */
//	 private JTextField getRefCondition(){
//		 if(refSubject == null){
//		 refSubject = new JTextField();
//		 //new 一个科目参照类
...
//		 }
	...
	private JTextField getRefProperty() {
		if (refProperty == null) { 
			...
			refProperty.addMouseListener(new MyPropertyMouseListener());
		}
		return refProperty;
	}
...
//	 }
	...
	//任务属性
	class MyPropertyMouseListener implements MouseListener {
...
//	}
	...
	private UIButton getBtnOk() {
		if (btnOk == null) {
			btnOk = new UIButton();
			btnOk.setBounds(new Rectangle(110, 140, 90, 22));
			btnOk.setText("确定");
	...
	private UIButton getBtnCancle() {
		if (btnCancle == null) {
			...
			btnCancle.setBounds(new Rectangle(311, 140, 100, 22));
