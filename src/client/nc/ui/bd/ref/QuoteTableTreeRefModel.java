...
public class QuoteTableTreeRefModel extends AbstractRefGridTreeModel{
	public QuoteTableTreeRefModel(){
		setRefNodeName( );
	}
...
//			setClassOrderPart(" ");
			...
			setHiddenFieldCode(new String[]{"pk_datadefinit_b"});
			setPkFieldCode("pk_datadefinit_b");
