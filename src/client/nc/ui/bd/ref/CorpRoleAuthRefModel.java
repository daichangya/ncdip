 ...
 * 数据接收定义中格式复制使用的参照
 * */
public class CorpRoleAuthRefModel extends AbstractRefModel{
	...
	public String getTableName() {
		return "sm_role left join bd_corp on sm_role.pk_corp=bd_corp.pk_corp and bd_corp.unitcode ='0001' ";
	}
