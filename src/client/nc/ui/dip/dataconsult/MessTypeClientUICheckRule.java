...
public class MessTypeClientUICheckRule extends BeforeActionCHK  implements ICheckRules,IUniqueRules,ICheckRules2{
...
//				new UniqueRule("编号不能重复！", new String[] {  "code"  })
//			};
...
//			ICheckRule[] isnull=null;
//			isnull = new ICheckRule[] {
