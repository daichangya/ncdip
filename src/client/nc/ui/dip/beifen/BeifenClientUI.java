 ...
 */
 public class BeifenClientUI extends AbstractBeifenClientUI {
       public BeifenClientUI(){
    	   super();
   		...
   		Boolean flag=(Boolean)getBillCardPanel().getBillModel().getValueAt(i, new DatacanzhaoVO().ISSYSPREF);
   		if(flag!=null&&flag){
...
//		Boolean flag=(Boolean)getBillCardPanel().getBillModel().getValueAt(row, new DatacanzhaoVO().ISSYSPREF);
//		if(flag!=null&&flag){
