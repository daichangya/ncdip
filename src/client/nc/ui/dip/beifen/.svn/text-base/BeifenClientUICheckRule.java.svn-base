...
public class BeifenClientUICheckRule extends BeforeActionCHK  implements ICheckRules,IUniqueRules,ICheckRules2{
	...
	public IUniqueRule[] getItemUniqueRules(String tablecode) {
		...
		unique=new IUniqueRule[]{
				new UniqueRule("表名不能重复！",new String[]{"tabname"}),
				new UniqueRule("备份形式不能重复！",new String[]{"xingshi"})
		};
