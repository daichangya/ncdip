 ...
 */
  public abstract class AbstractBeifenClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected ICardController  createController() {
		return new BeifenClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.beifen.MyDelegator();
	}
...
//		}
	...
	public Object getUserObject() {
		return new BeifenClientUICheckRuleGetter();
	}
