...
import nc.ui.dip.returnmess.ReturnMessClientUICheckRuleGetter;
 ...
 */
  public abstract class AbstractReturnMessClientUI extends nc.ui.trade.list.BillListUI implements  ILinkQuery{

	protected IListController createController() {
		return new ReturnMessClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.returnmess.MyDelegator();
	}
