 ...
 */
  public abstract class AbstractFilePathClientUI extends  nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new FilePathClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.filepath.MyDelegator();
	}
	...
	public Object getUserObject() {
		return new FilePathClientUICheckRuleGetter();
	}
