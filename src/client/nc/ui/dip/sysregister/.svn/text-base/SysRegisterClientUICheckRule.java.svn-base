...
public class SysRegisterClientUICheckRule extends BeforeActionCHK  implements ICheckRules,IUniqueRules,ICheckRules2{
	...
	public IUniqueRule[] getItemUniqueRules(String tablecode) {
		...
		unique=new IUniqueRule[]{
				new UniqueRule("分布站点编码不能重复!",new String[]{"sitecode"}),
				new UniqueRule("分布站点名称不能重复!",new String[]{"sitename"})
		};
		return unique;			
	}
