...
public class DataForDefClientUICheckRule extends BeforeActionCHK  implements ICheckRules,IUniqueRules,ICheckRules2{
...
//			new UniqueRule("内容不能重复",new String[]{"content"})
		};
