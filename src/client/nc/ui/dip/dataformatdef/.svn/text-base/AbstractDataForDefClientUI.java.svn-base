 ...
 *///AbstractReturnMessClientUI//AbstractDataFormatDefClientUI
  public abstract class AbstractDataForDefClientUI extends BillCardUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new  DataForDefClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.dataformatdef.MyDelegator();
	}
...
//		addPrivateButton(sb.getButtonVO());
		...
		addPrivateButton(up.getButtonVO());
		MoveddownBtn down=new MoveddownBtn();
		addPrivateButton(down.getButtonVO());
	}
...
//		return new ReturnMessClientUICheckRuleGetter();
		return new  DataForDefClientUICheckRuleGetter();
