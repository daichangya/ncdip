 ...
 */
 public class RepedtDataClientUI extends AbstractRepedtDataClientUI{
       
	 public RepedtDataClientUI(){
		 super();
...
//	   		Boolean flag=(Boolean)getBillCardPanel().getBillModel().getValueAt(i, new DipRepeatdataVO().ISSYSPREF);
//	   		if(flag!=null&&flag){
...
//		Boolean flag=(Boolean)getBillCardPanel().getBillModel().getValueAt(row, new DipRepeatdataVO().ISSYSPREF);
//		if(flag!=null&&flag){
