...
import nc.ui.dip.repeatdata.RepedtDataClientUICheckRuleGetter;
 ...
 */
  public abstract class AbstractRepedtDataClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected ICardController  createController() {
		return new RepedtDataClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.repeatdata.MyDelegator();
	}
...
//		}
	...
	public Object getUserObject() {
		return new RepedtDataClientUICheckRuleGetter();
	}
