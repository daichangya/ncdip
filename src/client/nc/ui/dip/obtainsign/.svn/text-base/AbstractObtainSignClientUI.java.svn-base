...
import nc.ui.dip.obtainsign.ObtainSignClientUICheckRuleGetter;
 ...
 */
  public abstract class AbstractObtainSignClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected ICardController createController() {
		return new ObtainSignClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.obtainsign.MyDelegator();
	}
...
//		}
	...
	public Object getUserObject() {
		return new ObtainSignClientUICheckRuleGetter();
	}
