...
//		addPrivateButton(sb.getButtonVO());
		...
		AddLineBtn addline=new AddLineBtn();
		addPrivateButton(addline.getButtonVO());
		DelLineBtn delline=new DelLineBtn();
		addPrivateButton(delline.getButtonVO());
		addPrivateButton(new ActionSetBtn().getButtonVO());
