...
import nc.ui.dip.buttons.FastSetBtn;
import nc.ui.dip.buttons.SetBtn;
import nc.ui.dip.buttons.ValidateCheckBtn;
import nc.ui.dip.contdatawh.ContDataWHClientUICheckRuleGetter;
...
public abstract class AbstractContdatawhClientUI extends BillTreeManageUI implements  ILinkQuery{
	...
	protected void initPrivateButton() {
		...
		AutoContDataBtn autoBtn=new AutoContDataBtn();
		addPrivateButton(autoBtn.getButtonVO());
		
		FastSetBtn fastSetBtn=new FastSetBtn();
		addPrivateButton(fastSetBtn.getButtonVO());
