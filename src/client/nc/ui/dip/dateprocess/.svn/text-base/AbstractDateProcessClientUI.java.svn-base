 ...
 */
  public abstract class AbstractDateProcessClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

//	protected AbstractManageController createController() {
//		return new DateProcessClientUICtrl();
//	}
	  /**
		 * 此方法关联控制器
		 */
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.dateprocess/*sourceregist*/.MyDelegator();
	}
...
//		}		
	...
	public Object getUserObject() {
		return new DateProcessClientUICheckRuleGetter();
	}
