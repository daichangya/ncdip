 ...
 */
  public abstract class AbstractAuthorizationIPClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new AuthorizationIPClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		...
		return new nc.ui.dip.authorization.ip.MyDelegator();
	}
	...
	public Object getUserObject() {
		return new AuthorizationIPClientUICheckRuleGetter();
	}
