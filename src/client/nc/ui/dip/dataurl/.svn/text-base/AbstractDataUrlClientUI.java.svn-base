 ...
 */
  public abstract class AbstractDataUrlClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected AbstractManageController  createController() {
		return new DataUrlClientUICtrl();
	}
	...
	public Object getUserObject() {
		return new DataUrlClientUICheckRuleGetter();
	}
