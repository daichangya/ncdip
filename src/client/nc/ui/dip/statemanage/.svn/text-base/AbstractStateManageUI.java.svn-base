 ...
 */
  public abstract class AbstractStateManageUI extends BillTreeCardUI implements ILinkQuery{

	  protected ICardController createController() {
			return new StateManageUICtrl();
		}
	...
	public Object getUserObject() {
		return new StateManageUICheckRuleGetter();
	}
