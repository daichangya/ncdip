...
public class StateManageUICheckRule extends BeforeActionCHK  implements ICheckRules,IUniqueRules,ICheckRules2{
	...
	public IUniqueRule[] getItemUniqueRules(String tablecode) {
		...
		/*unique=new IUniqueRule[]{
			new	 UniqueRule("中文名称不能为空",new String[]{"cname"}),
			new  UniqueRule("英文名称不能为空",new String[]{"ename"})
		};*/
