 ...
 */
  public abstract class AbstractTabStatusClientUI extends nc.ui.trade.list.BillListUI implements  ILinkQuery{

	protected IListController  createController() {
		return new TabStatusClientUICtrl();
	}
	...
	protected void initPrivateButton() {
		...
		int[] cardButns = getUIControl().getListButtonAry();
	...
	public Object getUserObject() {
		return new TabStatusClientUICheckRuleGetter();
	}
