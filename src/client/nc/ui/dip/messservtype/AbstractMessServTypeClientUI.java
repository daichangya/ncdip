 ...
 */
  public abstract class AbstractMessServTypeClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected ICardController createController() {
		return new MessServTypeClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.messservtype.MyDelegator();
	}
...
//		}
	...
	public Object getUserObject() {
		return new MessServTypeClientUICheckRuleGetter();
	}
