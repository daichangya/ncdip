 ...
 */
  public abstract class AbstractStatusRegistClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new StatusRegistClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.statusregist.MyDelegator();
	}
	...
	public Object getUserObject() {
		return new StatusRegistClientUICheckRuleGetter();
	}
