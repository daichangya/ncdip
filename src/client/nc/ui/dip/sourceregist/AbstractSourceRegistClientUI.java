 ...
 */
  public abstract class AbstractSourceRegistClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new SourceRegistClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.sourceregist.MyDelegator();
	}
	...
	public Object getUserObject() {
		return new SourceRegistClientUICheckRuleGetter();
	}
