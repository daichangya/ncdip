...
import nc.ui.dip.datadefcheck.DataDefinitClientUICheckRuleGetter;
 ...
 */
  public abstract class AbstractDataDefcheckClientUI extends BillTreeManageUI  implements ILinkQuery {

	  /**
		 * 此方法关联控制器
		 */
		protected AbstractTreeManageController createController() {
			return new DataDefcheckClientUICtrl();
		}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.datadefcheck.MyDelegator();
	}
