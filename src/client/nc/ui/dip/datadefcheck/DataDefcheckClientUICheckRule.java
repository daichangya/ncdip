...
public class DataDefcheckClientUICheckRule extends BeforeActionCHK  implements ICheckRules,IUniqueRules,ICheckRules2{
	...
	public IUniqueRule[] getItemUniqueRules(String tablecode) {
		...
		unique=new IUniqueRule[]{
				new UniqueRule("英文名称不能重复!",new String[]{"ename"})
		};
