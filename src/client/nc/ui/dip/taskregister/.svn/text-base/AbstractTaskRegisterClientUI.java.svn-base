 ...
 */
  public abstract class AbstractTaskRegisterClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new TaskRegisterClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.taskregister.MyDelegator();
	}
...
//		}
	...
	public Object getUserObject() {
		return new TaskRegisterClientUICheckRuleGetter();
	}
