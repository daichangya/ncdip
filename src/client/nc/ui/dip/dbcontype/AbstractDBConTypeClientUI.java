...
import nc.ui.dip.buttons.TestConnectBtn;
import nc.ui.dip.dbcontype.DBContypeClientUICheckRuleGetter;
 ...
 */
  public abstract class AbstractDBConTypeClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	  
	protected ICardController createController() {
		return new DBConTypeClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.dbcontype.MyDelegator();
	}
...
//		}
		...
		//连接测试按钮
		addPrivateButton(new TestConnectBtn().getButtonVO());
	}
	...
	public Object getUserObject() {
		return new DBContypeClientUICheckRuleGetter();
	}
