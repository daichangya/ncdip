...
import nc.ui.dip.dataverify.DataVerifyClientUICheckRuleGetter;
 ...
 *///AbstractReturnMessClientUI//AbstractDataFormatDefClientUI
  public abstract class AbstractDataVerifyClientUI extends nc.ui.trade.manage.BillManageUI implements  ILinkQuery{
//	  public abstract class AbstractDataVerifyClientUI extends BillCardUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new  DataVerifyClientUICtrl();
	}
	/**
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.dataverify.MyDelegator();
	}
	...
	public Object getUserObject() {
		return new DataVerifyClientUICheckRuleGetter();
	}
