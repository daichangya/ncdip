 ...
 */
//DataFormatDefClientUICheckRule

public class DataVerifyClientUICheckRule extends BeforeActionCHK  implements ICheckRules,IUniqueRules,ICheckRules2{
	...
	public IUniqueRule[] getItemUniqueRules(String tablecode) {
		...
		unique=new IUniqueRule[]{
			new UniqueRule("编码不能重复",new String[]{"code"}),
//			new UniqueRule("内容不能重复",new String[]{"content"}) // ytq 2011-07-02 去掉
		};
