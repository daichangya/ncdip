...
import nc.ui.dip.buttons.DealFileBtn;
import nc.ui.dip.buttons.SendFormBtn;
import nc.ui.dip.buttons.UpLoadFileBtn;
...
//			int[] listButns = getUIControl().getListButtonAry();
			...
			addPrivateButton(new DealFileBtn().getButtonVO());
			addPrivateButton(new UpLoadFileBtn().getButtonVO());
