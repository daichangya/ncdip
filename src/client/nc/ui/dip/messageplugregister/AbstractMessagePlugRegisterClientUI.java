 ...
 */
  public abstract class AbstractMessagePlugRegisterClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new MessagePlugRegisterClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.messageplugregister.MyDelegator();
	}
...
//		}
	...
	public Object getUserObject() {
		return new MessagePlugRegisterClientUICheckRuleGetter();
	}
