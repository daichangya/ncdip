 ...
 */
  public abstract class AbstractDataOriginClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected ICardController createController() {
		return new DataOriginClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.dataorigin.MyDelegator();
	}
...
//		}
	...
	public Object getUserObject() {
		return new DataOriginClientUICheckRuleGetter();
	}
