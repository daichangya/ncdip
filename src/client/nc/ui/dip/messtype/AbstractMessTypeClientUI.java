 ...
 */
  public abstract class AbstractMessTypeClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new MessTypeClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.messtype.MyDelegator();
	}
