...
public class RoleAndTableClientUICheckRule extends BeforeActionCHK  implements ICheckRules,IUniqueRules,ICheckRules2{
	...
	public IUniqueRule[] getItemUniqueRules(String tablecode) {
		...
		unique=new IUniqueRule[]{
			new UniqueRule("物理表名不能重复",new String[]{"memorytable"}),
			new UniqueRule("函数名称不能重复",new String[]{"functionname"})
		};
