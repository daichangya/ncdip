 ...
 */
  public abstract class AbstractFtpSourceRegisterClientUI extends  nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new FtpSourceRegisterClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.ftpsourceregister.MyDelegator();
	}
	...
	public Object getUserObject() {
		return new FtpSourceRegisterClientUICheckRuleGetter();
	}
