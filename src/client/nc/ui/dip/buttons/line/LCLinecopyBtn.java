...
public class LCLinecopyBtn {
	public ButtonVO getButtonVO(){
//		public final static int LCLineadd=147;
//		public final static int LCLinedel=148;
//		public final static int LCLinecopy=149;复制行
//		public final static int LCLineins=150;插入行
//		public final static int LCLinepast=151;粘贴行
		ButtonVO btnVo=new ButtonVO();
		btnVo.setBtnNo(149);
		btnVo.setBtnCode("LCLinecopy");
		btnVo.setBtnName("复制行");
		btnVo.setBtnChinaName("复制行");
