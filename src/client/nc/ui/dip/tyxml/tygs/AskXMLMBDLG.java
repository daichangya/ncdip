...
import nc.ui.bd.ref.TyzhXMLRefModel;
...
public class AskXMLMBDLG  extends UIDialog implements ActionListener{
	...
	*/
	...
	public AskXMLMBDLG(Container owner,SuperVO vo,String title,String message,String[] ss) {
		super(owner);
		this.pksys=vo.getAttributeValue("pk_xt")==null?"":vo.getAttributeValue("pk_xt").toString();
		this.pk_tyzhq_h=vo.getAttributeValue("pk_tyxml_h")==null?"":vo.getAttributeValue("pk_tyxml_h").toString();
	...
	private JPanel getMidPanel(){
	 ...
	 public UIRefPane getOrgnizeRefPnl(){
			if (refpnlOrgize == null){
				...
				TyzhXMLRefModel model = new TyzhXMLRefModel();
				model.addWherePart("  and nvl(dip_tyxml_h.dr,0)=0  and dip_tyxml_h.pk_tyxml_h<>'"+pk_tyzhq_h+"'");
