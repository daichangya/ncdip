 ...
 */
  public abstract class AbstractConsttabClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new ConsttabClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.recserver.MyDelegator();
	}
	...
	public Object getUserObject() {
		return new ConsttabClientUICheckRuleGetter();
	}
