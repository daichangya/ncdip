 ...
 */
public abstract class AbstractRunSysClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected ICardController createController() {
		return new RunSysClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.runsys.MyDelegator();
	}
	...
	public Object getUserObject() {
		return new RunSysClientUICheckRuleGetter();
	}
