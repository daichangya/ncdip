...
import nc.ui.dip.recstatus.RecStatusClientUICheckRuleGetter;
 ...
 */
  public abstract class AbstractRecStatusClientUI extends nc.ui.trade.manage.BillManageUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new RecStatusClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.recstatus.MyDelegator();
	}
	...
	public Object getUserObject() {
		return new RecStatusClientUICheckRuleGetter();
	}
