...
import nc.ui.dip.datastyle.DataStyleClientUICheckRuleGetter;
 ...
 */
  public abstract class AbstractAlertTypeClientUI extends nc.ui.trade.manage.BillManageUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new AlertTypeClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.alerttype.MyDelegator();
	}
