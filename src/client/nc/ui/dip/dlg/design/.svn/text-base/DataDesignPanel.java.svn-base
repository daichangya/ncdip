...
*/
public class DataDesignPanel extends UIPanel implements ActionListener,MouseListener,IBillModelDecimalListener{
//	private UITabbedPane jPanel1;
	...
	*/
	public static void main(String[] args) {
		...
		frame.getContentPane().add(new DataDesignPanel());
		frame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
		frame.pack();
		frame.setVisible(true);
	}
	
	public DataDesignPanel() {
		super();
		initGUI();
	}
	public DataDesignPanel(String[] pks,String[] pkfields) {
		super();
		this.pks=pks;
	...
	public DataDesignPanel(String[] pks,String[] pkfields,boolean isAuthorizeBrow) {
		super();
		this.pks=pks;
		this.pkfields=pkfields;
	...
	public DataDesignPanel(String[] pks,String[] pkfields,Integer notetype) {
		super();
		this.pks=pks;
		this.pkfields=pkfields;
...
//								}
			...
			if(isAuthorizeBrow){//如果是数据权限浏览格式，增加两个导入格式下拉的常量页签
				try {
					...
					dmap.put((1+"-"+0+"l"),vdipdesignvos);
					dmap.put((1+"-"+1+"l"),vdipdesignvos);
					dmap.put((1+"-"+2+"l"),vdipdesignvos);
					dmap.put((1+"-"+3+"l"),vdipdesignvos);
