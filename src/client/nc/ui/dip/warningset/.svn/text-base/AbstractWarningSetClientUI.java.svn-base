...
import nc.ui.dip.warningset.WarningSetClientUICheckRuleGetter;
 ...
 */
  public abstract class AbstractWarningSetClientUI extends nc.ui.trade.manage.BillManageUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new WarningSetClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.warningset.MyDelegator();
	}
	...
	protected void initPrivateButton() {
		...
		//同步按钮
		WarnTimeBtn warntime=new WarnTimeBtn();
		addPrivateButton(warntime.getButtonVO());
	}
	...
	public Object getUserObject() {
		return new WarningSetClientUICheckRuleGetter();
	}
