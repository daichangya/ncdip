...
import nc.ui.dip.recformat.RecFormatClientUICheckRuleGetter;
 ...
 */
  public abstract class AbstractRecFormatClientUI extends nc.ui.trade.manage.BillManageUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new RecFormatClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.recformat.MyDelegator();
	}
	...
	public Object getUserObject() {
		return new RecFormatClientUICheckRuleGetter();
	}
