...
public class DataCheckClientUICheckRule extends BeforeActionCHK  implements ICheckRules,IUniqueRules,ICheckRules2{
	...
	public IUniqueRule[] getItemUniqueRules(String tablecode) {
		...
		unique=new IUniqueRule[]{
				...
				new UniqueRule("名称不能重复!",new String[]{"name"}),
				new UniqueRule("实现类不能重复!",new String[]{"implementss"})
		};
