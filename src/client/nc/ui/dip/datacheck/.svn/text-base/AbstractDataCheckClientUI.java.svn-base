 ...
 */
  public abstract class AbstractDataCheckClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected ICardController createController() {
		return new DataCheckClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.datacheck.MyDelegator();
	}
...
//		}
	...
	public Object getUserObject() {
		return new DataCheckClientUICheckRuleGetter();
	}
