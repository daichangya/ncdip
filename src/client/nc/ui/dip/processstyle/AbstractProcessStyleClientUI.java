 ...
 */
  public abstract class AbstractProcessStyleClientUI extends nc.ui.trade.card.BillCardUI implements  ILinkQuery{

	protected AbstractManageController createController() {
		return new ProcessStyleClientUICtrl();
	}
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.dip.processstyle.MyDelegator();
	}
	...
	public Object getUserObject() {
		return new ProcessStyleClientUICheckRuleGetter();
	}
